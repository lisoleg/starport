...
import CosmonautPlanetCosmonautPlanetBlog from './cosmonaut/planet/cosmonaut.planet.blog'
...
export default { 
  CosmonautPlanetCosmonautPlanetBlog: load(CosmonautPlanetCosmonautPlanetBlog, 'cosmonaut.planet.blog'),
