...
export class Api extends HttpClient {
    constructor() {
         ...
         * @request GET:/cosmonaut/interchange/dex/denomTrace
         */
        this.queryDenomTraceAll = (query, params = {}) => this.request({
            path: `/cosmonaut/interchange/dex/denomTrace`,
            method: "GET",
            query: query,
            format: "json",
            ...params,
         ...
         * @request GET:/cosmonaut/interchange/dex/denomTrace/{index}
         */
        this.queryDenomTrace = (index, params = {}) => this.request({
            path: `/cosmonaut/interchange/dex/denomTrace/${index}`,
            method: "GET",
            format: "json",
            ...params,
        });
         ...
         * @request GET:/cosmonaut/interchange/dex/sellOrderBook
         */
        this.querySellOrderBookAll = (query, params = {}) => this.request({
            path: `/cosmonaut/interchange/dex/sellOrderBook`,
            method: "GET",
            query: query,
            format: "json",
            ...params,
         ...
         * @request GET:/cosmonaut/interchange/dex/sellOrderBook/{index}
         */
        this.querySellOrderBook = (index, params = {}) => this.request({
            path: `/cosmonaut/interchange/dex/sellOrderBook/${index}`,
            method: "GET",
            format: "json",
            ...params,
        });
