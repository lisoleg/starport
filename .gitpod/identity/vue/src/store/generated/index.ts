...
import LisolegIdentityLisolegIdentityIdentity from './lisoleg/identity/lisoleg.identity.identity'
...
export default { 
  ...
  LisolegIdentityLisolegIdentityIdentity: load(LisolegIdentityLisolegIdentityIdentity, 'lisoleg.identity.identity'),
